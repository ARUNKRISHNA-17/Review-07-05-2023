...
import com.review.demo.RService.LoanApplicationService;
...
public class LoanApplicationController 
{
	...
	@GetMapping("/get/{id}")
	public Optional<LoanApplicationModel> getDataById(@PathVariable("id")int id,@RequestBody AdminModel am)
	{
